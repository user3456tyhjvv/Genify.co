...
export default function ResetPassword() {
  ...
  const handleResetPassword = async (e) => {
    e.preventDefault();
    if (password.length < 8) return showNotification("error", "Password must be at least 8 characters.");
    if (password !== confirmPassword) return showNotification("error", "Passwords do not match.");
